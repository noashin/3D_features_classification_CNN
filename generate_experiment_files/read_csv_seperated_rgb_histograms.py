...
def generate_lmdbs(arguments_file):
    with open(arguments_file) as data_file:
        data_args = json.load(data_file)


    generate_single_lmdb(data_args["args"][6], False)
    generate_single_lmdb(data_args["args"][6], True)
    generate_single_lmdb(data_args["args"][7], False)
    generate_single_lmdb(data_args["args"][7], True)
