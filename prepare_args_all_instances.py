...
@click.option('--results_dir', type=click.STRING,
			  default='/mnt/scratch/noa/pclproj/results/lmdb_1601',
			  help='dictionary to save the json file')
@click.option('--file_name', type=click.STRING,
			  default='args_all_instances_2.json',
			  help='name to save the json file')

def main(source_dir, results_dir, file_name):
	args = save_download_args(source_dir, results_dir, file_name)
